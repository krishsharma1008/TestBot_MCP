  ...
  async generate({
    ...
    const report = {
      metadata: {
        ...
        explorationPhaseSource: typeof explorationSource === 'string' ? explorationSource : null,
        explorationPhaseRouteCount: (routeAccessSummary || generationMeta?.routeAccessSummary)?.totalObservedRoutes ?? null,
        staticRoutesAdded: typeof staticRoutesAdded === 'number' ? staticRoutesAdded : 0,

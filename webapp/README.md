...
| `OPENAI_MODEL` | No | Model override for all agents. Default: `gpt-5.5-mini`. |
| `OPENAI_API_AGENT_MODEL` | No | Model override for API contract test agent only. Default: `gpt-5`. Overrides `OPENAI_MODEL` for this agent. |

...
function StatusBadge({ status }: { status: string }) {
  ...
  if (s === 'completed-partial') return <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-orange-500/10 text-orange-300 border border-orange-500/25">Partial</span>;
